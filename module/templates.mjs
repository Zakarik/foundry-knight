...
export const PreloadTemplates = async function() {
  ...
  const templatePaths = [
    ...
    // Chemins morts (fichiers déplacés/supprimés lors de la réorganisation) : conservés
    // pour mémoire mais inactifs — `templatePaths` n'est de toute façon plus passé à loadTemplates.
    ...
    // Chemins morts actors/mechaarmure/*.html (réorganisation) : inactifs, conservés pour mémoire.
