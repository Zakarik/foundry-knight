...
export class KnightRollDialog extends Application {
    ...
    getData(options) {
      ...
      return {
        ...
        deploy:{
          wpnContact:this.data.deploy.wpnContact,
          wpnDistance:this.data.deploy.wpnDistance,
          wpnTourelle:this.data.deploy.wpnTourelle,
          wpnArmesImproviseesContact:this.data.deploy.wpnArmesImproviseesContact,
          wpnArmesImproviseesDistance:this.data.deploy.wpnArmesImproviseesDistance,
          grenades:this.data.deploy.grenades,
          longbow:this.data.deploy.longbow,
          wpnMA:this.data.deploy.wpnMA,
          wpnArmesImprovisees:this.data.deploy.wpnArmesImprovisees,
        },
        buttons: buttons
      }
    }
