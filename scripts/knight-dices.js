Hooks.on('diceSoNiceReady', (dice3d) => {
    ...
    dice3d.addSystem({ id: "original", name: "☑ Knight Origine", group: "Knight" }, "preferred");
    ...
    dice3d.addSystem({ id: "kaltg", name: "☑ Knight Alternative", group: "Knight" }, "default");
    dice3d.addDicePreset({
        type: "d6",
        labels: [
    ...
    dice3d.addSystem({ id: "kaltn", name: "☑ Knight Negative", group: "Knight" }, "default");
    dice3d.addDicePreset({
        type: "d6",
        labels: [
    ...
    dice3d.addSystem({ id: "kaltb", name: "☑ Knight Success Only", group: "Knight" }, "default");
    dice3d.addDicePreset({
        type: "d6",
        labels: [
